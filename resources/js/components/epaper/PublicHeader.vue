    ...
    <header class="sticky top-0 z-40 border-b border-slate-200 bg-white shadow-sm">
        <div class="mx-auto max-w-7xl px-4">
            ...
            <div class="flex items-center justify-between py-3">
                <a :href="siteUrl || '/'">
                    <img v-if="logoUrl" :src="logoUrl" alt="Newspaper logo"
                ...
                <div class="flex flex-col items-end gap-1">
                    <p class="text-sm font-medium text-slate-500 md:text-md">{{ formattedDate }}</p>
                    <div v-if="socialLinks.length > 0" class="flex items-center gap-0.5 sm:gap-1">
                        <a v-for="link in socialLinks" :key="link.icon" :href="link.href" :aria-label="link.label"
                            ...
                            <svg v-if="link.icon === 'facebook'" xmlns="http://www.w3.org/2000/svg"
                                class="size-3.5 sm:size-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                                <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
                            </svg>
                            <svg v-else-if="link.icon === 'x'" xmlns="http://www.w3.org/2000/svg"
                                class="size-3.5 sm:size-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                                <path
                                    d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                            </svg>
                            <svg v-else-if="link.icon === 'youtube'" xmlns="http://www.w3.org/2000/svg"
                                class="size-3.5 sm:size-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                                <path
                                    d="M22.54 6.42a2.78 2.78 0 0 0-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46a2.78 2.78 0 0 0-1.95 1.96A29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58A2.78 2.78 0 0 0 3.41 19.6C5.12 20 12 20 12 20s6.88 0 8.59-.46a2.78 2.78 0 0 0 1.95-1.95A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58zM9.75 15.02V8.98L15.5 12z" />
                            </svg>
                            <svg v-else-if="link.icon === 'linkedin'" xmlns="http://www.w3.org/2000/svg"
                                class="size-3.5 sm:size-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                                <path
                                    d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2z" />
                                <circle cx="4" cy="4" r="2" />
                            </svg>
                            <svg v-else-if="link.icon === 'instagram'" xmlns="http://www.w3.org/2000/svg"
                                class="size-3.5 sm:size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                                <rect width="20" height="20" x="2" y="2" rx="5" ry="5" />
                                <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" />
                                <line x1="17.5" x2="17.51" y1="6.5" y2="6.5" />
                            </svg>
                            <svg v-else-if="link.icon === 'pinterest'" xmlns="http://www.w3.org/2000/svg"
                                class="size-3.5 sm:size-4" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                                <path
